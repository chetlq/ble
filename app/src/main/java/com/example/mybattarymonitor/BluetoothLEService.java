...
public class BluetoothLEService extends Service {
    ...
    public final static UUID UUID_BATTERY_LEVEL =
            UUID.fromString(SampleGattAttributes.CURRENT_TIME);//.UUID_BATTERY_LEVEL_UUID);
...
//        }
    ...
    public void writeCharacteristic(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic, String s) {
